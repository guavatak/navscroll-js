...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return setDefaults; });
/* harmony export (immutable) */ __webpack_exports__["a"] = getDefaults;
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getVueComponentProps; });
...
function _getVueComponentProps(params) {
  ...
  var _loop = function _loop(prop) {
    var type = ['container'].includes(prop) ? null : getType(params[prop]);
    props[prop] = {
      type: type,
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  cubicBezierArrayFrom: function cubicBezierArrayFrom(easing) {
    ...
    if (typeof easing === 'string') {
      ...
      return easing.split(',').map(function (v) {
        return +v;
      });
    }
...
var install = function install(Vue, options) {
  ...
  Vue.config.globalProperties.$scrollTo = __WEBPACK_IMPORTED_MODULE_0__navscroll__["a" /* default */].scrollTo;
};
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  navItemsClassName: navItemsClassName,
...
function onUnbind(el) {
  var options = getBinding(el).binding;
  var defaultOpts = Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])();
...
function initObserver(wrapper, itemSelector, options) {
  ...
  function watcher(DOMMutations) {
    ...
    if (binding.clickToScroll === undefined ? defaultOpts.clickToScroll : binding.clickToScroll) {
      navigationItems.forEach(function (item) {
        var targetEl = binding.el || binding.element || item.hash || item.dataset.href;
...
function handleClick(e) {
  ...
  var options = getBinding(this).binding || {};
  var defaultOpts = Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])();
...
function onScroll(event) {
  ...
  var defaultOpts = Object(__WEBPACK_IMPORTED_MODULE_2__default_props__["a" /* default */])();
  var options = getBinding(elementWrapper).binding;
